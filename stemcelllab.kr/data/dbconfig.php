...
define('G5_MYSQL_USER', 'datamonster');
define('G5_MYSQL_PASSWORD', 'mondb2022@');
define('G5_MYSQL_DB', 'datamonster');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_stemcelllab');

define('G5_TOKEN_ENCRYPTION_KEY', '286e9bce729ffa4694283211c4057cd9'); // 토큰 암호화에 사용할 키
