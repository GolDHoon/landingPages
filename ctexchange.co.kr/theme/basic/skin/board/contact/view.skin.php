...
<style>
.board_list01 {font-size:18px; color:#000; font-weight:bold; text-align:center;}

</style>
<div class="wrap" style="width:70%; padding-bottom:30px;">

<p style="font-size:30px; font-weight:900;line-height:60px; text-align:left; ">
	<a href="/"><br><img src="../images/logo02.png" style="width:250px; height:auto;"></a></p>
</div>

<div class="wrap" style="width:70%; padding:50px; background:#fff; box-shadow:3px 3px 10px 10px rgba(0, 0, 0, 0.1); margin-bottom:100px;">
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
        	 <span class="board_list01"><?php echo $view['name'] ?> (연락처 : <?php echo $view['wr_1'] ?>) <?php echo $view['subject'] ?> </span>
    	</div>
...
;
    ...
    <section id="bo_v_atc">
		...
		<table>
			<tr>
				<td>
					<span class="board_list01">
						성함 : <?php echo $view['name'] ?><br>
						연락처 : <?php echo $view['wr_1'] ?><br>
